...
// Include the Bricktronics Megashield library and helper librarires
...
BricktronicsMotor syrup_arm(BricktronicsMegashield::MOTOR_1); // The syrup_arm object corresponds to the stir arm motor plugged into Motor Port 1.
BricktronicsMotor stir_arm(BricktronicsMegashield::MOTOR_2); // The stir_arm object corresponds to the syrup arm motor plugged into Motor Port 2.
BricktronicsButton startstop(BricktronicsMegashield::SENSOR_1); // The startstop object corresponds to the start/stop button in Sensor Port 1.
BricktronicsButton endstop(BricktronicsMegashield::SENSOR_2); // The endstop object corresponds to the endstop button in Sensor Port 2.
