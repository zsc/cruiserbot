...
BricktronicsMotor r(BricktronicsMegashield::MOTOR_1); // The r and l Motor objects correspond to the motors plugged into Motor Port 1 and 2, respectively, of the Bricktronics Megashield.
BricktronicsMotor l(BricktronicsMegashield::MOTOR_2);
BricktronicsButton front(BricktronicsMegashield::SENSOR_1); // The front Button object corresponds to the button plugged into Sensor Port 1.
