...
{
public:
	EV3UARTSensor(const BricktronicsSensorSettings &settings); // Create the sensor and specify the pins for SoftwareSerial
...
private:
	...
	SoftwareSerial *ss;                            // Reference to the SoftwareSerial object
